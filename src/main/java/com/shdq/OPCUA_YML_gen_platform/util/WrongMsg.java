...
public class WrongMsg {
    ...
    public static final String plcNo_MUST_BE_INTEGER = "必须是整数。\n";
    public static final String plcNo_MUST_NOT_NULL = "plcNo 编号不能为空。\n";
    public static final String ns_MUST_BE_INTEGER = "ns必须是整数。\n";
    public static final String ns_MUST_NOT_NULL = "ns不能为空。\n";
    ...
    public static final String sessionTimeOut_MUST_NOT_NULL = "会话过期时间不能为空。\n";
